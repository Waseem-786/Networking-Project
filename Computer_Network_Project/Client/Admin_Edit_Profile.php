...
if(isset($_POST['button']))
{
    ...
    $host    = $_SESSION["ip"];
    $port    = 4950;
    $message = array("Admin_Edit","Admin_Update",$fname,$lname,$father_name,$age,$num,$city,$country,$postal_code,$Img,$institute,$DOB,$email_1);
    ...
    <div class="container">
        <nav>
            <ul>
                ...
                <li class="list" id="list-2" onmouseover="showtext(2)" onmouseout="hidetext(2)"><a href="Admin_DashBoard.php"><img
...
$name = $_SESSION['name'];
    ...
    // $sql3 = "Select Ad_Image from Admin as Ad
            ...
            // on A.StdID = Ad.AdID
            // where A.Email = '$email' and A.type = '$type';";
...
$host    = $_SESSION["ip"];
$port    = 4950;
$message = array("Admin_Edit","Admin_Values",$email,$type);
$message = json_encode($message);
...
?>
                    ...
                    <input type="email" name="email" id="email" value="<?php echo $result[11]; ?>">
