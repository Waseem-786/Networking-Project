...
$host    = $_SESSION["ip"];
$port    = 4950;
$message = array("Student_Dashboard","name",$email);
...
?>                
                ...
                <a href="Student_Edit_Profile.php"><input type="button" value="Edit_Profile"></a>
...
$host    = $_SESSION["ip"];
$port    = 4950;
$message = array("Student_Dashboard","count_classes",$email);
$message = json_encode($message);
...
$host    = $_SESSION["ip"];
$port    = 4950;
$message = array("Student_Dashboard","classes",$email);
$message = json_encode($message);
...
?>
    <div class="subject">
        <p id="Crs"><?php echo $result[$i][0];?></p>
        <p> Credit Hours : <?php echo $result[$i][1]; ?></p>
        <p> Instructor : <?php echo $result[$i][2]." ".$result[$i][3]; ?></p>
        <p> Class Name : <?php echo $result[$i][4]; ?></p>
        <p> Start Time : <?php echo $result[$i][5]; ?></p>
        <p> End Time : <?php echo $result[$i][6]; ?></p>
    </div>
<?php
    $i++;
}
