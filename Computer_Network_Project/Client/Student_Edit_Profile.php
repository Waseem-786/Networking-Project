...
if(isset($_POST['button']))
{
    ...
    $host    = $_SESSION["ip"];
    $port    = 4950;
    $message = array("Student_Edit","Student_Update",$fname,$lname,$father_name,$age,$num,$city,$country,$postal_code,$Img,$institute,$batch,$section,$DOB,$Dept_Id,$email_1);
    ...
    <div class="container">
        <nav>
            <ul>
                ...
                <li class="list" id="list-2" onmouseover="showtext(2)" onmouseout="hidetext(2)"><a href="Student_DashBoard.php"><img
...
$host    = $_SESSION["ip"];
$port    = 4950;
$message = array("Student_Edit","Student_Values",$email,$type);
$message = json_encode($message);
...
?>
                    ...
                    <input type="text" name="batch" id="batch" value="<?php echo $result[10]; ?>">
                    
                    <label for="section">Section</label>
                    <input type="text" name="section" id="section" value="<?php echo $result[11]; ?>">
     
                    <label for="DOB">Date of Birth</label>
                    <input type="date" name="DOB" id="DOB" value="<?php echo $result[12]; ?>">
                    
                    <label for="institute">DeptID</label>
                    <input type="text" id="dept" name="deptId" value="<?php echo $result[13]; ?>">

                    <label for="email">Email Address</label>
                    <input type="email" name="email" id="email" value="<?php echo $result[14]; ?>">
