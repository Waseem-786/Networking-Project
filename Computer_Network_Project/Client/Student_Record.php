...
<?php
    ...
    if(isset($_POST['submit'])==false or isset($_POST['show']))  //Default and Show All Condition
    {
        ...
        $host    = $_SESSION["ip"];
        $port    = 4950;
        $message = array("Count_Student_Record");
    ...
    ?>
                <tr class='row'>
                    ...
                    <th><?php echo $result[$i][12]; ?></th>
                    <th><?php echo $result[$i][13]; ?></th>
                    <th><?php echo $result[$i][14]; ?></th>
                </tr>
    ...
    if(isset($_POST['submit']))
        {
            ...
            $host    = $_SESSION["ip"];
            $port    = 4950;
            $message = array("Count_Show_Student_Record",$search);
            $message = json_encode($message);
            ...
            $message = array("Show_Student_Record",$search);
            $message = json_encode($message);
